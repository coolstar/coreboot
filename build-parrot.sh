...
cbfstool ${filename2} add -f ./cbfs/links.sbib -n links -t raw
...
cbfstool ${filename4} add -f ./3rdparty/blobs/mainboard/google/parrot/snm_2137_ivb_parrot.dat -n pci8086,0106.rom -t optionrom
...
cbfstool ${filename4} add -f ./cbfs/links.sbib -n links -t raw

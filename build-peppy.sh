...
cbfstool ${filename2} add -f ./duet-hswbdw.img -n floppyimg/tianocore.img.lzma -t raw -c lzma
...
cbfstool ${filename4} add -f ./cbfs/links.hswbdw -n links -t raw
cbfstool ${filename4} add -f ./duet-hswbdw.img -n floppyimg/tianocore.img.lzma -t raw -c lzma
